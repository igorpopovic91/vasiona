...
```{r mapa, tidy=FALSE, echo=TRUE,fig.width=6, fig.height=9}
...
```{r mapa2, tidy=FALSE, echo=TRUE,fig.width=6, fig.height=9}
...
```{r mapa3, tidy=FALSE, echo=TRUE,fig.width=6, fig.height=9}
...
```{r mapa4, tidy=FALSE, echo=TRUE, fig.width=6, fig.height=9}
